...
namespace MasterDetailListView.Blazor.Server {
    public partial class MasterDetailListViewBlazorApplication : BlazorApplication {
        public MasterDetailListViewBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void MasterDetailListViewBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
